...
**When to use:** When you need to maintain cart state across sessions
...
**Description:** Reserve inventory when adding to cart or at checkout
**Example:**
```typescript
...
**Description:** Finite state machine for order states
**Example:**
```typescript
